...
#define Key_Tile        LSHIFT(Key_Backtick)
...
KEYMAPS(
  ...
  (
    ...
    ,Key_Tile        ,Key_Pipe        ,Key_Plus        ,Key_Underscore   ,Key_DoubleQuote ,Key_Esc
  ...
  (
    ...
    ,Key_PrintScreen ,___             ,Key_PageDown    ,Key_PageUp       ,___             ,___
    ,___             ,___             ,___             ,___              ,___             ,___
  ),
)
// clang-format on
