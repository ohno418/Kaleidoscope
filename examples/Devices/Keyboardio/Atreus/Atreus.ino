...
KEYMAPS(
  ...
  (
      ...
      ,Key_LeftShift ,MO(MISC)      ,Key_Quote          ,Key_LeftAlt         ,Key_Space               ,Key_LeftControl
  ...
  (
      ...
      ,___           ,___           ,Key_Equals         ,Key_Minus           ,Key_Quote
      ,Key_LeftShift ,___           ,LSHIFT(Key_Equals) ,LSHIFT(Key_Minus)   ,LSHIFT(Key_Quote)       ,___
      ,Key_LeftShift ,___           ,___                ,Key_LeftAlt         ,___                     ,Key_LeftControl

                     ,Key_6         ,Key_7              ,Key_8               ,Key_9                   ,Key_0
                     ,___           ,Key_LeftParen      ,Key_RightParen      ,LSHIFT(Key_LeftBracket) ,LSHIFT(Key_RightBracket)
