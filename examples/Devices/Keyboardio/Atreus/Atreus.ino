...
KEYMAPS(
  ...
  (
    ...
    ,Key_LeftShift   ,MO(MISC)        ,Key_RightAlt    ,Key_LeftShift    ,Key_Space       ,Key_LeftControl

                     ,Key_Y           ,Key_U           ,Key_I            ,Key_O           ,Key_P
                     ,Key_H           ,Key_J           ,Key_K            ,Key_L           ,Key_Semicolon
    ,Key_Backspace   ,Key_N           ,Key_M           ,Key_Comma        ,Key_Period      ,Key_Slash
    ,Key_Tab         ,Key_Enter       ,MO(SYMS)        ,M(MACRO_IME)     ,Key_Backtick    ,Key_Backslash
  ),
  ...
  (
    ...
    ,Key_LeftShift   ,___             ,Key_RightAlt    ,Key_LeftShift    ,Key_Space       ,Key_LeftControl
